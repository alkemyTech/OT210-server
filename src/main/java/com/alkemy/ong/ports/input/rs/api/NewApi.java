...
public interface NewApi {
    ...
    @Operation(summary = "Create new News", description = "Create new News", responses = {
    ...
    @Operation(summary = "Get News List", description = "Get News List", responses = {
    ...
    @Operation(summary = "Delete  News", description = "Delete  News", responses = {
    ...
    @Operation(summary = "update  News", description = "update  News", responses = {
            @ApiResponse(responseCode = "200", description = "ok",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
